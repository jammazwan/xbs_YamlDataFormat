...
Functionality: **_Yaml DataFormat inside a Camel route_**
...
Git clone the xbs_YamlDataFormat project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbs_YamlDataFormat.git
cd xbs_YamlDataFormat
mvn install -DskipTests

```

You man now import xbs_YamlDataFormat into your IDE.
...
_Run XbsTest. Also see NOTES.md_
